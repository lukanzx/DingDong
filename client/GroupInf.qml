...
Window {
    ...
    property string groupHead: ""
    property string pBackground: ""
    property string groupName: "CppGroup"
    property int groupID: 12345
    property string groupNotic: ""
    ...
    ColumnLayout {
        ...
        ToolButton {
            ...
            text: setFlag ? (reset.pressed ? qsTr("<font color='#57c1f2'>设置</font>") : reset.hovered ? qsTr("<font color='#57c1f2'>设置</font>") : ("<font color='#e1e7f2'>设置</font>")) : (reset.pressed ? qsTr("<font color='#57c1f2'>完成</font>") : reset.hovered ? qsTr("<font color='#57c1f2'>完成</font>") : ("<font color='#e1e7f2'>完成</font>"))
        ...
        ColumnLayout {
            ...
            Button {
                ...
                icon.source: sendMsg.pressed ? "qrc:/images/message1.png" : sendMsg.hovered ? "qrc:/images/message1.png" : ("qrc:/images/message.png")
