...
QQClient::QQClient(QQmlApplicationEngine *engine, QObject *parent) {
    ...
    QObject::connect(root, SIGNAL(loginSignal(int, QString)),
    ...
    QObject::connect(contactScreen, SIGNAL(requestContactSignal()),
                     this, SLOT(refreshContactFriend()));
    QObject::connect(contactScreen, SIGNAL(requestGroupSignal()),
                     this, SLOT(refreshContactGroup()));
...
void QQClient::changeGInfoRequest(QString groupName, QString groupNotice, QString groupSummary, int groupId) {
